...
fun Pose2d(matrix: OpenGLMatrix) = Pose2d(
        matrix.translation.get(0).toDouble(),
        // TODO("Figure out where this is matrix.get(1) (y) or matrix.get(2) (z)")
        matrix.translation.get(1).toDouble(),
        Orientation.getOrientation(matrix, AxesReference.EXTRINSIC, AxesOrder.XYZ, AngleUnit.DEGREES).thirdAngle.toDouble()
)