...
import org.firstinspires.ftc.teamcode.hardware.compbot.CompDriveConstants;
...
public class MecanumDrive2020 extends MecanumDrive {
    ...
    public MecanumDrive2020(HardwareMap hardwareMap) {
        ...
        velConstraint = new MinVelocityConstraint(Arrays.asList(
                ...
                new MecanumVelocityConstraint(MAX_VEL, CompDriveConstants.TRACK_WIDTH)
        ));
