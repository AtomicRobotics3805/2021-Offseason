 ...
 */
@Config
public class ThreeWheelTrackingLocalizer2020 extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 18.75; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 9.5; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;

    public ThreeWheelTrackingLocalizer2020(HardwareMap hardwareMap) {
        super(Arrays.asList(
