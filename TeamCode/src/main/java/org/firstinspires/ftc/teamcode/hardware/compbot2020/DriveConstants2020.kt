...
@Suppress("Unused")
@Config
object DriveConstants2020 : BaseDriveConstants() {
    /*
    ...
    @JvmField
    var _gearRatio = 1.053 // output (wheel) speed / input (motor) speed
    @JvmField
    var _trackWidth = 7.81 // in
    ...
    @JvmField
    var _kV = 1.0 / rpmToVelocity(maxRPM)
    @JvmField
    var _kA = 0.0
    @JvmField
    var _kStatic = 0.0
    ...
    @JvmField
    var _translationalPID = PIDCoefficients(10.0, 0.0, 0.0)
    @JvmField
